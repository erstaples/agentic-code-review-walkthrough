...
- 190 dependency-free tests pass, covering contract/source validation, dossier
...
- All 7 native integration tests pass against the extracted VSIX in VS Code
  1.139.0, using a disposable profile, repository, and dossier store.
...
RELAY_TOUR_MANUAL=1 RELAY_TOUR_OUTPUT=/absolute/path/to/results \
node editor-extension/test/integration/runner.js
```

The runner creates an isolated VS Code window titled **Relay acceptance ·
