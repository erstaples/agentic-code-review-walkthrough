...
Object.defineProperty(exports, "canonicalize", {
  enumerable: true,
  get: function () {
    return canonical_js_1.canonicalize;
  },
});
const errors_js_1 = require("./errors.js");
const domain_js_1 = require("./domain.js");
const narration_js_1 = require("../../../shared/narration.js");
...
function buildReceipt(state, sessionId, options = {}) {
      ...
      .map(
        ({
          ...
          beats: beats.map((beat) => ({
            id: beat.id,
            narration: (0, narration_js_1.renderNarration)(
              beat.narration,
              anchors,
              "receipt",
            ),
  ...
  return { ...receipt, digest: (0, canonical_js_1.digest)(receipt) };
}
