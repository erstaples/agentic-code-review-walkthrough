...
test("record contracts are versioned JSON Schema Draft 2020-12 documents", () => {
  for (const name of ["record", "event", "receipt", "tool-contracts", "presentation-anchor", "tour-plan"]) {
