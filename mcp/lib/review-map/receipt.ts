import type { Aggregate, Entity } from "./types.js";
...
function section(title: string, rows: string[], empty = "None.") {
...
function renderMarkdown(receipt: ReturnType<typeof buildReceipt>) {
  const lines = [
